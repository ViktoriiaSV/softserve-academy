...
let checkNumber =
  (writeNumber > 0 && writeNumber % 2 == 0) || writeNumber % 7 == 0;
...
let firstSide = parseFloat(
  prompt("Please write length of the side of the triangle")
);
...
if (firstSide * firstSide === secondSide * secondSide + thirdSide * thirdSide) {
  ...
  firstSide * firstSide + thirdSide * thirdSide
) {
  console.log("Triangle is right angle");
} else if (
  thirdSide * thirdSide ===
  secondSide * secondSide + firstSide * firstSide
) {
  console.log("Triangle is right angle");
} else {
